...
# HELP
bot.remove_command("Помощь") # Создание персональных команд 
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name =f"{bot.command_prefix}Помощь"))
